//
//  HoursExceptionsViewController.m
//  IUPUI_UL
//
...
@implementation HoursExceptionsViewController

@synthesize exceptionsArry;
...
- (void)viewDidLoad {
	...
	//Get Exceptions from XML
	Hours *hours = [[Hours alloc] init];
	exceptionsArry = [hours exceptions];
	[hours release];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    // Configure the cell
	NSDictionary *labels = [exceptionsArry objectAtIndex:indexPath.row];
